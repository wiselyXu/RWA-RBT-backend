...
#[salvo(schema(example = json!({
    ...
    "ipfs_hash": "Qmabcdef1234567890abcdef1234567890abcdef12345678", // 匹配 ipfs_hash
    "contract_hash": "0x1a2b3c4d5e6f7a8b9c0d1e2f3a4b5c6d7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a2b", // 匹配 contract_hash, 示例为合约/交易哈希字符串
